# bubble_sort_ruby
In this project, we created two functions of the bubble sorting algorithm. One that only accepts an array, and another that accepts an array and a block of code. This is a project proposed by [The Odin Project](https://www.theodinproject.com/courses/ruby-programming/lessons/advanced-building-blocks) and is part of the [Microverse curriculum](https://www.microverse.org/#world-class-curriculum).
